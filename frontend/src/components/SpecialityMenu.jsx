...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Find by Style Expertise</h1>
            <p className='sm:w-1/3 text-center text-sm'>Browse our collection of specialized styling services and find the perfect stylist for your unique hair transformation.</p>
